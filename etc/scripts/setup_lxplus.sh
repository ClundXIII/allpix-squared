...
export G4INSTALL=/cvmfs/sft.cern.ch/lcg/releases/Geant4/10.05.p01-94a77/x86_64-centos7-gcc62-opt/
source $G4INSTALL/bin/geant4.sh
export CMAKE_PREFIX_PATH="$G4INSTALL:$CMAKE_PREFIX_PATH"
# Point to corresponding CLHEP
export CMAKE_PREFIX_PATH="/cvmfs/sft.cern.ch/lcg/releases/clhep/2.4.1.0-2c56f/x86_64-centos7-gcc62-opt:$CMAKE_PREFIX_PATH"
